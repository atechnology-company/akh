...
<div
	class="about-page"
	style="--gradient-color-1: {gradientColors[0] ||
		'#1a2a6c'}; --gradient-color-2: {gradientColors[1] ||
		'#b21f1f'}; --gradient-color-3: {gradientColors[2] || '#fdbb2d'};"
>
		...
		<div class="about-container">
			{#if showHeading}
				<h1
					...
					class:gradient-active={gradientActive}
					data-greeting={greetingText}
				>
					{greetingText}
				</h1>
			{/if}
			...
			{#if showContent}
				<div
					...
					transition:slide={{ duration: 800, easing: cubicOut, axis: 'y' }}
				>
					<div class="content-fade" in:fade={{ duration: 600, delay: 200 }}>
						<p>
							i'm max, or abdurrahman, and i am a cantonese-english muslim teen and the founder of <span
								style="color: #ff5705;">a</span
							>technology company. i started akh because there are a lot of salah time apps, however
							none looked exactly the way i wanted them to or had the feature set i wanted. i want
							something minimal and something that looks beautiful. i like making applications and
							it is my job, you can view my
							<a href="https://undivisible.dev/" class="personal-link">personal website</a>
							and my
							<a href="https://atechnology.company/" class="business-link">business website</a>.
						</p>
						<p>
							now, you may notice there are two buttons at the bottom. the left one goes to my <a
								href="https://buymeacoffee.com/undivisible"
								class="link-donations">link for donations</a
							>. i make no money off personal projects like these, so it is appreciated. i always
							put it back into my projects, charity, or i eat food. i usually work alone, or i have
							some brothers that help every now and then. however, "the other button" goes to the
							<a href="https://www.alihsan.org.au/project/emergency-appeal" class="foundation-link"
								>Al-Ihsan Foundation</a
							>, and they support people who actually need it, unlike me. (i have some other sources
							of income). i'm just leaving that option open, it's there.
						</p>
			...
			{#if showButtons}
				<div class="buttons" transition:slide={{ duration: 400, easing: cubicOut, axis: 'y' }}>
					...
					>
					<a href="https://www.alihsan.org.au/project/emergency-appeal" class="foundation-button"
						>{t('the_other_button')}</a
					>
				</div>
			{/if}
		</div>
	...
	<div class="version-info">
		akh v0.3.6 debug test alpha - an <span style="color: #ff5705;">a</span>technology company
		project
	</div>
</div>
...
<style>
	...
	.business-link:not(:hover),
	.link-donations:not(:hover),
	.foundation-link:not(:hover) {
		background-position: 0% center;
	}
